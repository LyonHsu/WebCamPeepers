        ...
        implements SurfaceHolder.Callback
{
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        mAverageSpf = (TextView) findViewById(R.id.mAverageSpf);
    } // onCreate(Bundle)

    public void changeSpf(String s){
    ...
    private Handler handler =  new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what==1)
            {
                setAverageSpf(msg.obj.toString());
            }
        }
    };

    public void setAverageSpf(String s){
        mAverageSpf.setText(s);
    }
    ...
    private void tryStartCameraStreamer()
    {
        if (mRunning && mPreviewDisplayCreated && mPrefs != null)
        {
            mCameraStreamer = new CameraStreamer(mCameraIndex, mUseFlashLight, mPort,
                    mPrevieSizeIndex, mJpegQuality, mPreviewDisplay,this);
